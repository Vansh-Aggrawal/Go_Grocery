...
<body>
    ...
    <form class="box" method="post" action = forgotpass>
        <h2>Change Password</h2>
        <input type="text" placeholder="Username" name='username'>
        <input type="text" placeholder="id" name='id'>
        <input type = "text" placeholder = "New Password" name='Npassenter' >
        <input type ="password" placeholder = "Re-Enter Password" name = 'NpassReEnter'>
        <input type="submit" value="Login">
        <a href="login.jsp" class="forgot">Login Page</a>
    </form>
